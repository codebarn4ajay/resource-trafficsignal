...
public class TaskSchedulerTest {
    private TrafficMovementService taskScheduler = new TrafficMovementService();
...
//        List<List<CrossingLane>> signalsToHandle = TaskScheduler.getSignalsToHandle();
//        List<CrossingLane> signalStreetWrappers = streetToSignalQueueTransformer.fromStreetToSignal(addStreetCrossing());
